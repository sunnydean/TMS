//answers.unity3d.com/questions/918410/ambiguous-reference-preview.html?sort=oldest
#pragma strict
...
{	
  ...
  var preview_ : SerializedProperty;								//FIX 23ap15 there wasn't "_"
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    preview_ = serObj.FindProperty ("preview");						//FIX 23ap15 there wasn't "_"
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (preview_, new GUIContent("Preview"));	//FIX 23ap15 there wasn't "_"
    if (preview_.boolValue)		//FIX 23ap15 there wasn't "_"
